...
(function(g) {
    ...
    q(z.prototype, {
        ...
        getSVG: function(b) {
            var a = this,
                e, c, f, y, h, d = l(a.options, b),
                I = d.exporting.allowHTML;
            ...
            e.destroy();
            p(c);
            if (I && (c = f.match(/<\/svg>(.*?$)/))) c = '<foreignObject x="0" y="0" width="200" height="200"><body xmlns="http://www.w3.org/1999/xhtml">' + c[1] + "</body></foreignObject>", f = f.replace("</svg>", c + "</svg>");
        ...
        contextMenu: function(b, a, e, c, f, g, h) {
            ...
            if (!i) d[k] = i = j("div", {
                ...
                if (a) {
                    var b =
                        a.separator ? j("hr", null, null, v) : j("div", {
            ...
            c + g + d.exportMenuHeight >
                o && h.alignOptions.verticalAlign !== "top" ? a.bottom = o - c - t + "px" : a.top = c + g - t + "px";
            u(i, a);
            d.openMenu = !0
        },
        ...
        destroyExport: function(b) {
            ...
            for (a = 0; a < b.exportSVGElements.length; a++)
                if (e = b.exportSVGElements[a]) e.onclick = e.ontouchstart = null, b.exportSVGElements[a] = e.destroy();
            for (a = 0; a < b.exportDivElements.length; a++) e = b.exportDivElements[a], A(e, "mouseleave"), b.exportDivElements[a] = e.onmouseout = e.onmouseover = e.ontouchstart =
                e.onclick = null, p(e)
        }
    });
